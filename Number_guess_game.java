...
public class Number_guess_game
{
	public static void main(String[] args) {
        ...
        "3 - If the user guessing number is greater than computer generated number then player can guess number again.\n" +
        "4 - If the user guessing number is lesser than computer generated number then player can guess number again.\n" +
        ...
        while(chances-->0){
            ...
            if(step>number){
                f=false;
                System.out.println("Your Guessing Number is Greater than Generated Number!!");
            }
            else if(step<number){
                f=false;
                System.out.println("Your Guessing Number is Lesser than Generated Number!!");
            }
            else{
                JOptionPane.showMessageDialog(null,"Conrats, you win the Game. You Guess the Number in "+(i)+" Steps and Your Guessing number is "+number);
                win=true;
                break; }
            i++; }
            if(!win){
        JOptionPane.showMessageDialog(null,"Your Chances exhausted. Your loose the Game"); }
	}
}